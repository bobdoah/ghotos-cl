...
GOOGLE_PICASAWEB_ALBUM_URL = 'https://picasaweb.google.com/data/feed/api/user/default/albumid/{album_id}?prettyprint=true&fields=title,entry(title,id)&max-results=10'
